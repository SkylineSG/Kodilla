...
public class BookDirectoryTestSuite {
    ...
    @Test
    public void testBooksInHandsZeroBooks(){
        // Given
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        ...
        //When
        List<Book> resoultListOfZeroBooks = bookLibrary.listBooksInHandsOf(isA(LibraryUser.class));
        //Then
        Assert.assertEquals(0, resoultListOfZeroBooks.size());
        verify(libraryDatabaseMock, times(1)).listBooksInHandsOf(any(LibraryUser.class));
    }

    @Test
    public void testBooksInHandsOneBooks(){
        // Given
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        ...
        List<Book> resoultListOfZeroBooks = bookLibrary.listBooksInHandsOf(isA(LibraryUser.class));
        //Then
        Assert.assertEquals(1, resoultListOfZeroBooks.size());
        verify(libraryDatabaseMock, times(1)).listBooksInHandsOf(any(LibraryUser.class));
    }

    @Test
    public void testBooksInHandsFiveBooks(){
        // Given
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        ...
        List<Book> resoultListOfZeroBooks = bookLibrary.listBooksInHandsOf(isA(LibraryUser.class));
        //Then
        Assert.assertEquals(5, resoultListOfZeroBooks.size());
        verify(libraryDatabaseMock, times(1)).listBooksInHandsOf(any(LibraryUser.class));
    }
